...
with open('../data/{}/{}_{}_{}_{}{}.bal.pkl'.format(args.dataset, args.dataset, args.feats, args.sep, cut, args.group), 'wb') as f:
...
emb = np.loadtxt('../data/top.emb', delimiter=',')
allzeros = np.all(emb == 0, axis=1)

plot_embedding(emb=emb[~allzeros], labels=labels.numpy()[~allzeros], ppl=30, cmap_code='jet', 
            fname='../results/{}_{}_{}_{}_emb{}.bal.png'.format(args.dataset, args.feats, args.sep, cut, args.group))
